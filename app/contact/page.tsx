                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="mt-1">
                                        ...
                                        <p className="text-slate-600 font-medium">contact@tilemerchant.ie</p>
                            ...
                            <form className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        id="message"
                                        rows={5}
                                        className="w-full px-6 py-4 rounded-2xl neu-inset bg-[#E5E9F0] focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all resize-none text-slate-800 placeholder:text-slate-400"
